		...
		<nav id="navigation" class="menu">
			...
			<?php 
				if ( is_user_logged_in() ) { ?>
					...
					<li><a href="<?php echo esc_url($loginlink); ?>"><i class="fa fa-sign-out"></i> <?php esc_html_e('Profile','workscout') ?></a></li>
					<?php } ?>
		    	...
		    	$.magnificPopup.open({
				  items: {
				    src: '<div id="singup-dialog" class="small-dialog zoom-anim-dialog apply-popup">'+
		                	...
		                	'<div class="small-dialog-content"><p class="margin-reset"><?php esc_html_e("You have successfully registered and Email will be sent for verification. Thank you!","workscout"); ?></p></div>'+
