...
function workscout_scripts() {
	...
	if ( defined( 'JOB_MANAGER_VERSION' ) ) {
		...
		$wpdb->prepare('
		    ...
		    FROM %1$s
		    LEFT JOIN %2$s ON %1$s.ID = %2$s.post_id
		    WHERE meta_key IN ("' . implode( '","',  array( '_rate_max' ) ) . '")  AND post_status = "publish"
...
function custom_submit_resume_form_fields( $fields ) {
    ...
    $fields['resume_fields']['candidate_education']['fields']['date']['label'] = "Start date";
	$fields['resume_fields']['candidate_education']['fields']['date-end'] = array(
   		'label'       => __( 'End date', 'workscout' ),
    ...
    $fields['resume_fields']['candidate_experience']['fields']['date']['label'] = "Start date";
	$fields['resume_fields']['candidate_experience']['fields']['date-end'] = array(
   		'label'       => __( 'End date', 'workscout' ),
...
add_filter( 'resume_manager_resume_education_fields', 'workscout_split_education_field' );
function workscout_split_education_field( $fields ){
	
	$fields['date-end'] = array(
		    'label'       => esc_html__( 'End Date', 'workscout' ),
		    'type'        => 'text',
		    'required'    => false,
		    'placeholder' => '',
		    'priority'    => 7
...
add_filter( 'resume_manager_resume_experience_fields', 'workscout_split_experience_field' );

function workscout_split_experience_field( $fields ){
...
function remove_submit_resume_form_fields( $fields ) {
	...
	$fields['resume_fields']['candidate_rate_min']['placeholder'] = 'e.g. $20.00'; 
...
function frontend_add_salary_field( $fields ) {
	...
	$fields['job']['job_location']['placeholder'] = 'e.g. "US"'; 
	$fields['job']['rate_min']['placeholder'] = 'e.g. $20.00'; 
	$fields['job']['rate_max']['placeholder'] = 'e.g. $50.00'; 
	$fields['job']['salary_min']['placeholder'] = 'e.g. $20.00'; 
	$fields['job']['salary_max']['placeholder'] = 'e.g. $50.00'; 
