...
class pw_new_user_approve {
	...
	public function default_authentication_message( $status ) {
		...
		if ( $status == 'pending' ) {
			$message = __( '<div class="body_clr" style="background: rgb(240, 240, 240);
    height: 100%;
    margin: 0;
    padding: 0;"><div class="error" style="
...
"><p style="font-size:18px
    ...
    background-color: rgb(240, 240, 240);
">Your account is still pending approval.</p></div></div>', 'new-user-approve' );
...
"><p style="font-size:18px
    ...
    color: rgb(136, 136, 136);
    background-color: rgb(240, 240, 240);
">Your account has been denied access to this site.</p></div></div>', 'new-user-approve' );
